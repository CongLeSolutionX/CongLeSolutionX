...
<p align="center"><q>Just a regular kid <br/>love mixing digital art and AI models<br/> to build things <br/>as hobby for my own academic research.</q></p>
...
- 🔭 My current focus is a natural-language processing iOS app, <ins>which is used to be the capstone project for my Master's program</ins>, ~which concluded in June 2025~ and the initial work is finally in this [repo](https://github.com/CongLeSolutionX/On_device_real_time_AI_assistant),...*I'm <ins>**slowly**</ins> setting up the <ins>CI/CD strategy</ins> for this project now*...👨🏼‍💻🏗🧠🤖
