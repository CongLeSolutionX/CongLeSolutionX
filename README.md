...
<p align="center">Just a regular kid <br/>love mixing digital art and AI models<br/> to build things <br/>as hobby for my own academic research</p>
...
- 📝 I publish articles on iOS development and its integration with AI tools ~sometimes~ occasionally on [Medium.com/@CongLeSolutionX](https://www.medium.com/@CongLeSolutionX), where still hosting my older tech articles, focusing on the technical concepts and components I use in my capstone project.
...
- 💬 Currently, the pursuit of understanding the (<ins>potentially</ins>) <b>mysterious connections and relationships</b> among the projects below <ins>as personal interests and self-studying</ins> is all-consuming, frequently keeping me working from dusk 🌄 till dawn 🌅.
